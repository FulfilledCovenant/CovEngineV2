...
json GO() {
    json result;
    json memory;
    memory["total"] = 32 * 1024 * 1024 * 1024LL; // 32 GB in bytes
    memory["available"] = 24 * 1024 * 1024 * 1024LL; // 24 GB in bytes
    memory["used"] = 8 * 1024 * 1024 * 1024LL; // 8 GB in bytes
    memory["percent"] = 25; 
    
    json swap;
    swap["total"] = 16 * 1024 * 1024 * 1024LL; // 16 GB in bytes
    swap["used"] = 2 * 1024 * 1024 * 1024LL; // 2 GB in bytes
    swap["free"] = 14 * 1024 * 1024 * 1024LL; // 14 GB in bytes
    swap["percent"] = 12; 
...
json GD() {
    ...
    disk1["mount"] = "C:";
    disk1["fs_type"] = "NTFS";
    disk1["total"] = 500 * 1024 * 1024 * 1024LL; // 500 GB in bytes
    disk1["used"] = 300 * 1024 * 1024 * 1024LL; // 300 GB in bytes
    disk1["free"] = 200 * 1024 * 1024 * 1024LL; // 200 GB in bytes
    disk1["percent"] = 60; 
    ...
    disk2["mount"] = "D:";
    disk2["fs_type"] = "NTFS";
    disk2["total"] = 1000 * 1024 * 1024 * 1024LL; // 1 TB in bytes
    disk2["used"] = 500 * 1024 * 1024 * 1024LL; // 500 GB in bytes
    disk2["free"] = 500 * 1024 * 1024 * 1024LL; // 500 GB in bytes
    disk2["percent"] = 50; 
...
json GN() {
    ...
    interface1["bytes_sent"] = 1024 * 1024 * 10; // 10 MB
    interface1["bytes_recv"] = 1024 * 1024 * 100; // 100 MB
    ...
    interface2["bytes_sent"] = 1024 * 1024 * 5; // 5 MB
    interface2["bytes_recv"] = 1024 * 1024 * 50; // 50 MB
