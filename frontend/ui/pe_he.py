...
class HE(QWidget):
    ...
    def stUI(self):
        ...
        welcome_msg = QLabel("Welcome to CovEngineV2, your ultimate gaming performance optimizer. "
    ...
    def pf_as(self, progress_dialog):
        try:
            ...
            if self.analysis_results["processes"] < 120:
                ...
                score = 80
                recommendation = "Good gaming performance. Consider closing some background applications."
